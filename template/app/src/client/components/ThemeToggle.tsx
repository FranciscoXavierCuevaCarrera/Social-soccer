...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      type="button"
      className="flex cursor-pointer items-center gap-2 rounded-xl border px-3 py-1.5 shadow-sm transition-all duration-300
    ...
    >
      {isDark ? (
        <>
          <Sun className="h-4 w-4 text-[#FF6B35] animate-pulse" />
