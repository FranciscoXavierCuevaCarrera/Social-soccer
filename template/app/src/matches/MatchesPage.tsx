  ...
  const upcomingMatches = [
    {
      ...
      weatherAlert: '🌧️ Alerta Meteorológica: Lluvia Fuerte Prevista a las 15:00 — Partido Confirmado en Drenaje Sintético',
      status: 'SCHEDULED',
      vocaliaPaid: true,
    },
    {
      ...
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-bold tracking-tight">Próximos Partidos & Logística AI</h1>
          </div>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="p-4 rounded-xl border border-amber-500/40 bg-amber-50 dark:bg-amber-950/40 text-amber-900 dark:text-amber-200 flex items-start gap-3 shadow-md">
          ...
          <div>
            ...
            <p className="text-xs mt-0.5 leading-relaxed">
              Monitoreo meteorológico activo: Las notificaciones push notifican de inmediato cualquier cambio de hora o cancha para evitar traslados inútiles (&quot;ir de gana&quot;).
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {upcomingMatches.map((match) => (
            <div
              key={match.id}
              className="rounded-xl border p-5 shadow-lg transition-all duration-300 hover:shadow-xl
            ...
            >
              ...
              <div className="flex flex-wrap justify-between items-center gap-2 pb-3 mb-4 border-b border-slate-100 dark:border-slate-700/60">
                ...
                <div className="flex items-center gap-2">
                  <span className={`text-[11px] font-bold px-2.5 py-0.5 rounded-full border ${
                    ...
                    {match.vocaliaPaid ? 'Vocalía Pagada ✓' : 'Vocalía Pendiente'}
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 items-center text-center my-4 py-2">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[10px] text-muted-foreground font-semibold uppercase mt-0.5">Local</span>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[11px] font-mono text-muted-foreground mt-1">{match.time}</span>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[10px] text-muted-foreground font-semibold uppercase mt-0.5">Visitante</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs pt-3 mt-2 border-t border-slate-100 dark:border-slate-700/60">
                ...
                <div className="flex items-center gap-1.5 text-muted-foreground sm:justify-end">
                  ...
                  <span>Árbitro Asignado: <strong className="text-foreground">{match.referee}</strong></span>
                </div>
              </div>
            </div>
          ))}
